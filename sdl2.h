...
namespace sdl
{
  ...
  static SDL_Color const dark_green{0x00, 0x40, 0x00, SDL_ALPHA_OPAQUE};
  ...
  static SDL_Color const dark_yellow{0x40, 0x40,  0x20, SDL_ALPHA_OPAQUE};
  static SDL_Color const dark_red{0x60, 0x10, 0x10, SDL_ALPHA_OPAQUE};
